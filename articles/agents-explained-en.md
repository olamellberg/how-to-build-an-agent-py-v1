...
This chapter includes the copy-paste template that previously lived on its own page. Keep it repo-specific, short, and explicit — the goal is stable, reusable context.
